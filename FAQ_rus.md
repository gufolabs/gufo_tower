...
Для инсталяций типа eval и test локальные правки блокируют обновление. Локальные правки должны храниться в отдельной диреткории custom. Структура этого каталога должна повторять структуру в основном репозитарии. Локальные комимты для этих типов инсталяции будут отклонены. 
