...
-- );
INSERT INTO environment VALUES(1,'docs','The installation intended for the documentation purposes','test','Docs','simple.test.example.com',0,'yaml:///opt/noc/etc/tower.yml,yaml:///opt/noc/etc/settings.yml,env:///NOC','git','git+https://github.com/gufolabs/noc@stable','ed25519');
-- settings
