...
INSERT INTO settings VALUES('installation_name','"Simple fixture"');
...
-- );
INSERT INTO node VALUES(1,1,1,'n01','testing node','10.0.0.1','ansible',1,'x86_64','QEMU Virtual CPU version 2.5+',4,11960,'Debian','12.14','kvm',22);
-- role
...
INSERT INTO service VALUES(2,1,'discovery',1,1,'{"backup_power": 1, "loglevel": "info", "max_threads": 20, "power": 2}',1);
INSERT INTO service VALUES(3,1,'mx',NULL,1,'{"loglevel": "info", "power": 1}',0);
INSERT INTO service VALUES(4,1,'mib',NULL,1,'{"loglevel": "info", "power": 1}',1);
...
INSERT INTO service VALUES(7,1,'metrics',NULL,1,'{"backup_power": 1, "loglevel": "info", "power": 2}',1);
INSERT INTO service VALUES(8,1,'scheduler',NULL,1,'{"loglevel": "info", "max_threads": 10, "power": 1}',1);
...
INSERT INTO service VALUES(10,1,'login',NULL,1,'{"language": "en", "loglevel": "info", "methods": "local", "pam_service": "noc", "power": 2, "radius_secret": null, "radius_server": null, "session_ttl": "7d"}',1);
INSERT INTO service VALUES(11,1,'kafka',NULL,1,'{"cluster_id": "", "insecure_certs": false, "memory_limit": 1}',1);
INSERT INTO service VALUES(12,1,'postgres',NULL,1,'{"max_clients": 300, "noc_db": "noc", "noc_password": "noc", "noc_user": "noc", "power": "master", "replicator_password": "noc", "superuser_password": "noc", "version": "14"}',1);
INSERT INTO service VALUES(13,1,'nginx',NULL,1,'{"cert": null, "cert_key": null, "external_cert_management": "False", "http_redirect": "True", "json_logging": "False", "permit_firewall": true, "self_signed_cerificate": "True"}',1);
INSERT INTO service VALUES(14,1,'mongod',NULL,1,'{"db": "noc", "logging_destination": "syslog", "password": "noc", "power": "server", "rs": "noc", "user": "noc", "version": "4.4"}',1);
...
INSERT INTO service VALUES(21,1,'sae',NULL,1,'{"db_threads": 4, "loglevel": "info", "power": 2}',1);
...
INSERT INTO service VALUES(37,1,'chwriter',NULL,1,'{"batch_delay_ms": 1000, "batch_size": 50000, "channel_expire_interval": 300, "loglevel": "info", "power": 1, "records_buffer": 1000000}',1);
INSERT INTO service VALUES(38,1,'clickhouse',NULL,1,'{"db": "noc", "expose_metrics": true, "max_ast_elements": 10000, "password": "noc", "query_size": 262144, "ro_grafana_password": "noc", "ro_password": "noc", "timezone": "Europe/Moscow", "user": "noc"}',1);
...
INSERT INTO service VALUES(41,1,'web',NULL,1,'{"language": "en", "loglevel": "info", "max_threads": 10, "power": 2, "theme": "gray"}',1);
